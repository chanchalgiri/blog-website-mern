...
const salt = bcrypt.genSaltSync(10);//bcrypt
const secret = 'sjcsbixatbkxohdn';//jwt(randomly entered value)
...
app.put('/post',uploadMiddleware.single('file'),async(req,res) => {
    ...
    jwt.verify(token, secret, {}, async(err,info) => {
        ...
        if(!isAuthor){
            return res.status(400).json("NOT THE AUTHOR OF THE POST");
        }
